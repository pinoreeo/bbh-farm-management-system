...
<section id="beranda" class="relative min-h-[860px] scroll-mt-[72px] overflow-hidden bg-[#00aa13] text-white sm:min-h-[800px] lg:h-[711px] lg:min-h-0 lg:scroll-mt-[84px]">
    ...
    <div class="relative mx-auto h-full max-w-[1184px] px-6 py-10 sm:px-8 lg:px-0 lg:py-12">
        ...
        <img src="{{ asset('hero-goats-cutout.png') }}" alt="{{ $copy['hero']['goat_alt'] }}" class="bbh-goat-cutout relative z-20 mx-auto -mb-9 mt-8 w-[360px] max-w-none sm:w-[430px] lg:absolute lg:-bottom-[3px] lg:-right-[220px] lg:m-0 lg:w-[900px]">
    </div>
</section>
