...
<section id="galeri" class="scroll-mt-[72px] border-b border-[#dfe9d9] bg-white px-6 py-12 sm:px-8 lg:scroll-mt-[84px] lg:px-10 lg:py-16">
    ...
    <div class="relative mx-auto mt-8 max-w-[1184px]" data-gallery-carousel>
                ...
                @foreach ($copy['gallery']['items'] as $item)
                    <figure class="bbh-gallery bbh-gallery-slide relative h-[440px] shrink-0 overflow-hidden bg-[#101820] text-white md:h-[390px] lg:h-[410px]">
                        ...
                        <figcaption class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#101820]/95 via-[#101820]/58 to-transparent px-6 pb-8 pt-24 sm:px-8">
                            ...
                            <p class="mt-2 max-w-xl bbh-text text-white/85">{{ $item[2] }}</p>
                        </figcaption>
                    </figure>
                @endforeach
            </div>
        ...
        <button type="button" class="absolute left-3 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-[#dfe9d9] bg-white/95 text-[var(--bbh-action)] shadow-none transition hover:bg-[#f7faf4]" aria-label="{{ $copy['gallery']['previous'] }}" data-gallery-prev>
        ...
        <button type="button" class="absolute right-3 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-[#dfe9d9] bg-white/95 text-[var(--bbh-action)] shadow-none transition hover:bg-[#f7faf4]" aria-label="{{ $copy['gallery']['next'] }}" data-gallery-next>
